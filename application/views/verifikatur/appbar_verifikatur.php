<div class="app-bar fixed-top darcula" data-role="appbar">
        ...
        <ul class="app-bar-menu">
            <li><a href="<?php echo base_url('verifikatur');?>">Dashboard</a></li>
            <li>
               <!--  <a href="" class="dropdown-toggle">Tambah Berkas</a>
        ...
        <div class="app-bar-element place-right">
            <span class="dropdown-toggle"><span class="mif-cog"></span>verifikatur</span>
